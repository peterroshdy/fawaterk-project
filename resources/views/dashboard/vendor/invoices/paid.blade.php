            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">@lang('invoices.Paid_Invoices')</h4>
                                <p class="text-muted page-title-alt">@lang('invoices.Here_is')</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                        	...
                        	<div class="col-lg-12">
                        		<div class="card-box">
                        			...
                        			<h4 class="text-dark header-title m-t-0">@lang('invoices.Recent_Paid')</h4>
