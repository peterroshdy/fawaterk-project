        ...
        <div class="invoice-box">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr class="total">
                    ...
                    <td colspan="3">{{ $store->tax_name_1}}</td>
                    @endif
                    
                    <td>@if($store->tax_name_1 && $store->tax_amount_1)
                        {{ $store->tax_amount_1 * $items_sum / 100 }}$
                ...
                <tr class="total">
                    ...
                    <td>
                        @if($store->tax_name_1 && $store->tax_amount_1)
                        {{ $store->tax_amount_1 * $items_sum / 100 + $items_sum + $store->shipping_fees}}$
                        
                        @else
                        {{ $items_sum + $store->shipping_fees}}$
                        @endif
                    </td>
                </tr>
            ...
            <br>
            <div class="col-md-3 col-xs-4 " style="margin:auto;float:none;">
                <img src="http://chart.googleapis.com/chart?chs=200x200&cht=qr&chl={{$order->qrcode_link}}" alt="QRCode"/>
            </div>
            <!--
            <div class="row">
            ...
            <form method="POST" action="{{ url('/store/'.$store->vendor_username.'/order/'.$order->id.'/payment-method') }}">
                ...
                @if($store->tax_name_1 && $store->tax_amount_1)
                <input required name="total" value="{{ $store->tax_amount_1 * $items_sum / 100 + $items_sum + $store->shipping_fees}}" type="hidden" class="form-control">
                
                @else
                <input required name="total" value="{{ $items_sum + $store->shipping_fees}}" type="hidden" class="form-control">
                @endif
