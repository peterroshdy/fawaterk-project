...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        // Registration Routes for Vendor...
        $this->get('register_vendor', 'Auth\RegisterController@register_vendor_show')->name('register_vendor');
        $this->post('register_vendor', 'Auth\RegisterController@register_vendor_store')->name('register_vendor');
        
        // Registration Routes for customer...
        $this->get('/store/{username}/customer/register', 'Auth\RegisterController@register_customer_show');
        $this->post('/store/{username}/customer/register', 'Auth\RegisterController@register_customer_store')->name('register_customer');
